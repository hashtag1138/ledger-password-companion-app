...
CASES: tuple[PersistenceCase, ...] = (
    PersistenceCase(
        ...
        note="Etat simple relu après restart via l'écran de liste",
        entries=(SeedEntry("sofian terki"),),
        post_restart_action="list",
    ),
    PersistenceCase(
        case_id="sofian_restart_show_first",
        note="Etat simple relu après restart via show password",
        entries=(SeedEntry("sofian terki"),),
    ...
    PersistenceCase(
        ...
        note="Etat simple relu après restart via type password",
        entries=(SeedEntry("sofian terki"),),
    ...
    PersistenceCase(
        ...
        note="Deux entrées valides relues après restart puis show du second item",
    ...
    PersistenceCase(
        ...
        note="Liste dense de 12 entrées relue après restart puis show du dernier item",
    ...
    PersistenceCase(
        ...
        note="Raw corrompu accepté puis relu après restart avant show du second item",
