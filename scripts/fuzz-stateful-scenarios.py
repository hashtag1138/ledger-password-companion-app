...
SCENARIOS: tuple[StatefulScenario, ...] = (
    StatefulScenario(
        ...
        note="Régression directe autour du nickname incident puis lecture show",
    ...
    StatefulScenario(
        ...
        note="Type password après push d'un nickname avec espace",
        entries=(ScenarioEntry("sofian terki"),),
    ...
    StatefulScenario(
        ...
        note="Delete juste après push d'un nickname avec espace",
        entries=(ScenarioEntry("sofian terki"),),
    ...
    StatefulScenario(
        ...
        note="Lecture show avec espace en tête",
    ...
    StatefulScenario(
        ...
        note="Typing avec espace en tête",
        entries=(ScenarioEntry(" leading"),),
        steps=(ScenarioStep("push"), ScenarioStep("type", position=1)),
        expected_final_nicknames=(" leading",),
    ),
    StatefulScenario(
        ...
        note="Sélection second item dans la liste",
    ...
    StatefulScenario(
        ...
        note="Mix type sur un item puis delete d'un autre",
    ...
    StatefulScenario(
        ...
        note="Push puis verify puis pull sur corpus multi-entrée",
