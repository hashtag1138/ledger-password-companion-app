...
CASES: tuple[MutationCase, ...] = (
    MutationCase(
        ...
        note="First entry length inflated to overlap the next one",
    ...
    MutationCase(
        ...
        note="First entry charset forced to 0xFF",
        seed_entries=(SeedEntry("github"), SeedEntry("gmail")),
    ...
    MutationCase(
        ...
        note="Inconsistent kind on the second entry",
        seed_entries=(SeedEntry("github"), SeedEntry("gmail")),
    ...
    MutationCase(
        ...
        note="Second entry length extended by one byte into padding",
        seed_entries=(SeedEntry("github"), SeedEntry("gmail")),
    ...
    MutationCase(
        ...
        note="Second entry length forced to overflow into the buffer",
        seed_entries=(SeedEntry("github"), SeedEntry("gmail")),
    ...
    MutationCase(
        ...
        note="Remove the terminator, then fill the tail with 0xFF",
        seed_entries=(SeedEntry("github"), SeedEntry("gmail")),
    ...
    MutationCase(
        ...
        note="Non-zero padding after intact terminator",
        seed_entries=(SeedEntry("github"), SeedEntry("gmail")),
